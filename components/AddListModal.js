    ...
    renderColor=()=>{
     // backgroundColor=["#F44336", "#E91E63","#9C27B0","#673AB7","#2196F3","#4CAF50","#FF9800"]
        ...
        return this.backgroundColor.map(color=>{
            return(
                <TouchableOpacity key={color} style={{width:30, height:30, borderRadius:4, backgroundColor:color}} 
        ...
        return(
           ...
           behavior="padding">
                ...
                <View style={{alignSelf:"stretch", marginHorizonal:32}}>
                    ...
                    <View style={{paddingLeft:25, width:330, flexDirection:"row", justifyContent:"space-around", marginTop:12}}></View>
